...
class UserManagement extends Controller
{
  ...
  public function create()
  {
    ...
    return view('content.laravel-example.user-create', compact('roles', 'user'));
  }
    ...
    if ($userID) {
      ...
      $user = User::updateOrCreate(
        ...
        [
          'name' => $request->name,
          'email' => $request->email,
          'role_id' => $request->role_id // Añadir el rol seleccionado
        ]
      );
      ...
      if (empty($userEmail)) {
        ...
        return response()->json(['message' => "El email ya existe"], 422);
      }
    }
  }
