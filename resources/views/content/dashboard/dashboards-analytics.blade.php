    ...
    <div class="swiper-container swiper-container-horizontal swiper swiper-card-advance-bg" id="swiper-with-pagination-cards">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="row">
            <div class="col-12">
              <h5 class="text-white mb-0">Analisis de Planes
              </h5>
              {{-- <small>Total 28.5% Conversion Rate</small> --}}
            </div>
            <div class="row">
              <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1 pt-md-9">
                <h6 class="text-white mt-0 mt-md-3 mb-4">Planes Totales</h6>
                <div class="row">
                  <div class="col-6">
  ...
  <div class="col-xl-3 col-sm-6">
    <div class="card h-100">
      <div class="card-header pb-0">
        <h5 class="mb-3 card-title">Total de dinero desembolsado</h5>
        <p class="mb-0 text-body">Hasta la fecha</p>
        <h4 class="mb-0">COP</h4>
        <h4 class="mb-0">$ 220,225,632,991</h4>
    ...
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          <p class="mb-0 text-body">Valores estimados</p>
        ...
        <div class="row">
          <div class="col-4">
            <div class="d-flex gap-2 align-items-center mb-2">
              ...
              <p class="mb-0">Estimado</p>
            </div>
            {{-- <h5 class="mb-0 pt-1">62.2%</h5> --}}
            <span class="text">COP</span>
            <span class="text-muted">220,225,632,991</span>
          ...
          <div class="col-4 text-end">
            ...
            <span class="text"> COP</span>
            <span class="text-muted"> 93,882,944,165</span>
    ...
    <div class="card h-100">
      <div class="card-header pb-0 d-flex justify-content-between">
        <div class="card-title mb-0">
          <h5 class="mb-1">Total de usuarios registrados</h5>
          <p class="card-subtitle">Detalles del total de usuarios, roles y permisos creados</p>
        </div>
        <div class="dropdown">
          ...
          <div class="row gap-4 gap-sm-0">
            <div class="col-12 col-sm-4">
              <div class="d-flex gap-2 align-items-center">
                ...
                <h6 class="mb-0 fw-normal">Usuarios creados</h6>
              </div>
              <h4 class="my-2">30</h4>
            ...
            <div class="col-12 col-sm-4">
              <div class="d-flex gap-2 align-items-center">
                ...
                <h6 class="mb-0 fw-normal">Roles Creados</h6>
              </div>
              <h4 class="my-2">8</h4>
              <div class="progress w-75" style="height:4px">
            ...
            <div class="col-12 col-sm-4">
              <div class="d-flex gap-2 align-items-center">
                ...
                <h6 class="mb-0 fw-normal">Permisos creados</h6>
              </div>
              <h4 class="my-2">25</h4>
              <div class="progress w-75" style="height:4px">
  ...
  <div class="col-md-6">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between">
        <div class="card-title mb-0">
          <h5 class="mb-1">Seguimiento de planes</h5>
          {{-- <p class="card-subtitle"> 7 Days</p> --}}
        </div>
        {{-- <div class="dropdown">
        ...
        <div class="col-12 col-sm-4 col-md-12 col-lg-4">
          ...
          <ul class="p-0 m-0">
            <li class="d-flex gap-4 align-items-center mb-lg-3 pb-1">
              ...
              <div>
                <h6 class="mb-0 text-nowrap">Planes creados</h6>
            ...
            <li class="d-flex gap-4 align-items-center mb-lg-3 pb-1">
              ...
              <div>
                <h6 class="mb-0 text-nowrap">Planes en revision</h6>
            ...
            <li class="d-flex gap-4 align-items-center pb-1">
              ...
              <div>
                <h6 class="mb-0 text-nowrap">Planes en ejecucion</h6>
