          ...
          <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
            ...
            <ul class="dropdown-menu dropdown-menu-end p-0">
              <li class="dropdown-menu-header border-bottom">
                <div class="dropdown-header d-flex align-items-center py-3">
                  <h6 class="mb-0 me-auto">Notificación</h6>
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item list-group-item-action dropdown-notifications-item">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="small mb-1">Calors Perez 🎉</h6>
                        <small class="mb-1 d-block text-body">Se acaba de autorizar el plan 52154</small>
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mb-1 small">Anres Fernandez</h6>
                        <small class="mb-1 d-block text-body">El plan 32654 no ha sido autorizado</small>
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mb-1 small">Andres Romero </h6>
                        <small class="mb-1 d-block text-body">El plan 54641 ha sido autorizado</small>
                        <small class="text-muted">1h ago</small>
                      </div>
                      <div class="flex-shrink-0 dropdown-notifications-actions">
                        <a href="javascript:void(0)" class="dropdown-notifications-read"><span class="badge badge-dot"></span></a>
